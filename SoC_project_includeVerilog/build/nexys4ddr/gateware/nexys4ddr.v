//--------------------------------------------------------------------------------
// Auto-generated by Migen (a5cc037) & LiteX (5097b7ae) on 2020-12-03 03:08:22
//--------------------------------------------------------------------------------
module nexys4ddr(
...
wire builder_csrbank11_mem_adr0_re;
wire [18:0] builder_csrbank11_mem_adr0_r;
wire builder_csrbank11_mem_adr0_we;
wire [18:0] builder_csrbank11_mem_adr0_w;
wire builder_csrbank11_mem_we0_re;
wire builder_csrbank11_mem_we0_r;
wire builder_csrbank11_mem_we0_we;
wire builder_csrbank11_mem_we0_w;
wire builder_csrbank11_mem_data_w0_re;
wire [11:0] builder_csrbank11_mem_data_w0_r;
wire builder_csrbank11_mem_data_w0_we;
wire [11:0] builder_csrbank11_mem_data_w0_w;
wire builder_csrbank11_mem_data_r_re;
wire [11:0] builder_csrbank11_mem_data_r_r;
wire builder_csrbank11_mem_data_r_we;
wire [11:0] builder_csrbank11_mem_data_r_w;
...
assign builder_csrbank11_mem_adr0_r = builder_interface11_bank_bus_dat_w[18:0];
assign builder_csrbank11_mem_adr0_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank11_mem_adr0_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank11_mem_we0_r = builder_interface11_bank_bus_dat_w[0];
assign builder_csrbank11_mem_we0_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank11_mem_we0_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank11_mem_data_w0_r = builder_interface11_bank_bus_dat_w[11:0];
assign builder_csrbank11_mem_data_w0_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank11_mem_data_w0_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank11_mem_data_r_r = builder_interface11_bank_bus_dat_w[11:0];
assign builder_csrbank11_mem_data_r_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[1:0] == 2'd3));
assign builder_csrbank11_mem_data_r_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[1:0] == 2'd3));
assign builder_csrbank11_mem_adr0_w = basesoc_mem_adr_storage[18:0];
assign builder_csrbank11_mem_we0_w = basesoc_mem_we_storage;
assign builder_csrbank11_mem_data_w0_w = basesoc_mem_data_w_storage[11:0];
assign builder_csrbank11_mem_data_r_w = basesoc_mem_data_r_status[11:0];
assign basesoc_mem_data_r_we = builder_csrbank11_mem_data_r_we;
assign basesoc_mem_data_r_re = builder_csrbank11_mem_data_r_re;
...
always @(posedge sys_clk) begin
	...
	if (builder_csrbank11_sel) begin
		case (builder_interface11_bank_bus_adr[1:0])
			1'd0: begin
				builder_interface11_bank_bus_dat_r <= builder_csrbank11_mem_adr0_w;
			end
			1'd1: begin
				builder_interface11_bank_bus_dat_r <= builder_csrbank11_mem_we0_w;
			end
			2'd2: begin
				builder_interface11_bank_bus_dat_r <= builder_csrbank11_mem_data_w0_w;
			end
			2'd3: begin
				builder_interface11_bank_bus_dat_r <= builder_csrbank11_mem_data_r_w;
			end
		endcase
	end
	if (builder_csrbank11_mem_adr0_re) begin
		basesoc_mem_adr_storage[18:0] <= builder_csrbank11_mem_adr0_r;
	end
	basesoc_mem_adr_re <= builder_csrbank11_mem_adr0_re;
	if (builder_csrbank11_mem_we0_re) begin
		basesoc_mem_we_storage <= builder_csrbank11_mem_we0_r;
	end
	basesoc_mem_we_re <= builder_csrbank11_mem_we0_re;
	if (builder_csrbank11_mem_data_w0_re) begin
		basesoc_mem_data_w_storage[11:0] <= builder_csrbank11_mem_data_w0_r;
	end
	basesoc_mem_data_w_re <= builder_csrbank11_mem_data_w0_re;
	if (sys_rst) begin

...
_io = [
    ...
    ("led", 12, Pins("P5"), IOStandard("LVCMOS33")),
    ("led", 13, Pins("U1"), IOStandard("LVCMOS33")),
    ("led", 14, Pins("R2"), IOStandard("LVCMOS33")),
    ("led", 15, Pins("P2"), IOStandard("LVCMOS33")),


    ("display_cs_n",  0, Pins("N6 M6 M3  N5 N2 N4 L1 M1"), IOStandard("LVCMOS33")),
    ...
    ("sw",  8, Pins("U4"),  IOStandard("LVCMOS33")),
    ("sw",  9, Pins("V2"),  IOStandard("LVCMOS33")),
    ("sw", 10, Pins("U2"), IOStandard("LVCMOS33")),
    ("sw", 11, Pins("T3"), IOStandard("LVCMOS33")),
    ("sw", 12, Pins("T1"),  IOStandard("LVCMOS33")),
    ("sw", 13, Pins("R3"), IOStandard("LVCMOS33")),
    ("sw", 14, Pins("P3"), IOStandard("LVCMOS33")),
    ("sw", 15, Pins("P4"), IOStandard("LVCMOS33")),

    # Buttons
    ("btnc", 0, Pins("T16"), IOStandard("LVCMOS33")),
    ("btnd", 0, Pins("R10"), IOStandard("LVCMOS33")),
    ("btnu", 0, Pins("F15"), IOStandard("LVCMOS33")),
    ("btnr", 0, Pins("V10"), IOStandard("LVCMOS33")),
    ("btnl", 0, Pins("E16"), IOStandard("LVCMOS33")),
...
#        Subsignal("vga_red", Pins("A4 C5 B4 A3")),
#        Subsignal("vga_green", Pins("A6 B6 A5 C6")),
#        Subsignal("vga_blue", Pins("D7 C7 B7 D8")),
#        IOStandard("LVCMOS33")
#    ),
